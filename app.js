...
let objectLit = _ => ({ key1: 'value1', key2: 'value2', key3: 'value3' });
...
Student.prototype.greeting = _ => `Hi, my name is ${this.name}`;
...
// its th all Student proprety
// 2. What is "this" when joe.scopeArrow() is invoked?
// the This method window
// 3. Explain why "this" is different when an arrow function is used.
// because the arrow scope is much globel !!
